		...
		<div class="select-menu">
			...
			<div class="dropdown trade">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
					...
					<input type='radio' id="selectAll" class='ichecked'
						name="salestype" checked> &nbsp; 전체 <br> <input
						type='radio' class='ichecked' name="salestype"> &nbsp; 월세
					<br> <input type='radio' class='ichecked' name="salestype">
					&nbsp; 매매
				</div>
			</div>
			<!-------------------------------- 가격 드롭다운 -------------------------------->
