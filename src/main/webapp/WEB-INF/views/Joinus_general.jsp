...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/Joinus_general.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/terms01.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/terms02.css">
			...
			<div class="main-space">
				<div class="container">
					...
					<div class="main-content">
						<form name="filter" class="policy_all" role="form" method="post"
							id="result01" style="display: block;">
							<div>
								<ul class="gallery">
									<li class="cover01"><span class="cover02"><img
											class="circle"
											src="${pageContext.request.contextPath}/assets/img/noname0.png"
											alt="약관동의" width="120" /></span></li>
									<li class="cover01"><span class="cover02"><img
											class="circle"
											src="${pageContext.request.contextPath}/assets/img/contract1.png"
											alt="약관동의" width="120" /></span>
										<div class="text">약관동의</div></li>
									<li class="cover01"><span class="cover02"><img
											class="circle"
											src="${pageContext.request.contextPath}/assets/img/contract2.png"
											alt="약관동의" width="120" /></span>
							...
							<div style="text-align: left;">
								<input type="checkbox" name="agree01" id="agree_all"> <label
									for="check_box">아래 약관에 모두 동의합니다.</label>
							</div>
							<br />
							<div style="text-align: left;">
							...
							<div style="text-align: left;">
								<input type="checkbox" name="agree" id="agree" /> <label
									for="check_box">개인정보 수집 및 이용에 대한 동의(필수)</label>
							</div>
							<div class="policy">
							...
							<div class="general01_btn">
								<input type="button" class="btn btn-primary" id="pass_ge01"
						...
						<form name="filter" class="personal_info" role="form"
							...
							<div>
								<ul class="gallery">
									...
									<li class="cover01"><span class="cover02"><img
											class="circle"
											src="${pageContext.request.contextPath}/assets/img/contract3.png"
											alt="약관동의" width="120" /></span>
								...
								<tbody>
									...
									<tr>
										...
										<td><input type="text" name="user_name" id="user_name"
											class="form-control" maxlength="20" placeholder="이름을 입력해주세요">
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" name="user_email" id="user_email"
											...
											<input type="checkbox" name="direct" id="direct" value="Y"
											onclick="formChange()" /> <label for="agree_y">직접입력</label></td>
									</tr>
									<tr>
										<th class="active"><span class="left-name">비밀번호</span></th>
										<td><input type="password" name="Rpw" id="Rpw"
											class="form-control" maxlength="20"
											placeholder="비밀번호를 입력해주세요"></td>
									</tr>
									<tr>
										<th class="active"><span class="left-name">비밀번호 확인</span></th>
										<td><input type="password" name="Npw" id="Npw"
											class="form-control" maxlength="20"
											placeholder="비밀번호를 확인해주세요"></td>
									</tr>
									<tr>
										<th class="active"><span class="left-name">휴대폰 번호</span></th>
										<td><input type="text" name="phoneNumber1"
											id="phoneNumber1" class="form-control" maxlength="20"
											placeholder="휴대폰번호를 입력해주세요"></td>
									</tr>
								</tbody>
							</table>
							<div class="general02_btn on" style="text-align: center;">
								<input type="submit" class="btn btn-primary" id="submit_ge02"
									value="입력완료" name="checkButton"
									style="height: 50px; width: 100px; margin: 50px">
								<!-- button type="submit" 형식으로 하면 페이지 전환이 안먹힘 -->
							</div>
						</form>
						...
						<form name="filter" class="join_complete" role="form"
							...
							<div class="box1">
								<h5>회원가입이 완료되었습니다.</h5>
								<img
									src="${pageContext.request.contextPath}/assets/img/complete.png" />
							</div>
							<div>
		...
		$(function() {
			...
			$("#result02").submit(
					function(e) {
						...
						/** 비밀번호 검사 */
						if (!regex.value('#Rpw', '비밀번호를 입력하세요.')) {
							return false;
						}
						if (!regex.min_length('#Rpw', 4,
								'비밀번호는 최소 4자 이상 입력 가능합니다.')) {
							return false;
						}
						if (!regex.max_length('#Rpw', 20,
								'비밀번호는 최대 20자 까지만 입력 가능합니다.')) {
							return false;
						}
						if (!regex.compare_to('#Rpw', '#Npw',
								'비밀번호 확인이 잘못되었습니다.')) {
							return false;
						}

						/** 연락처 검사 */
						if (!regex.value('#phoneNumber1', '번호를 입력하세요.')) {
							return false;
						}
						if (!regex.phone('#phoneNumber1', '번호가 잘못되었습니다.')) {
							return false;
						}
