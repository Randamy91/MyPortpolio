...
<body>
	 <div class="sg-main">
        ...
        <section class="sg-agent">
            ...
            <ol>
                <li>
                    ...
                    <span class="sg-text">세모: "회사"가 제공하는 위치기반서비스입니다.</span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <span class="sg-text">고객: "세모"에 접속하여 서비스를 이용하는 이용자를 말합니다.</span>
                </li>
                <li>
                    <span class="listNum">4.</span>
                    <span class="sg-text">
                        회원: "세모"에 접속하여 "회사"에 개인정보를 제공하고 본 약관에 따라 회사가 제공하는 서비스를 받는 "개인
        ...
        <section class="sg-agent">
            ...
            <ol>
                ...
                <li>
                    <span class="listNum">3.</span>
                    <span class="sg-text">
                        "회사"는 위치정보사업자인 이동통신사로부터 위치정보를 전달받아 "세모"의 모바일 단말기 전용 애플리케이
                        ...
                        <ol>
                            ...
                            <li>
                                <span class="listNum">4)</span>
                                <span class="sg-text">
                                    "고객"의 위치 정보의 갱신은 "세모" 실행 시 또는 실행 후, 위치 관련 메뉴 이용 시 이루어지며, "고객"이 갱신
        ...
        <section class="sg-agent">
            <h2>제 6조 이용시간</h2>
            <p>
                "세모"의 이용은 24시간 가능합니다. 단, 시스템 장애, 프로그램 오류 보수, 외부요인 등 불가피한 경우에는 해당 공
                지를 통해 사전에 통지합니다.
            </p>
        </section>
        <section class="sg-agent">
                ...
                <li>
                    ...
                    <span class="sg-text">
                        ...
                        <dl>
                            ...
                            <dd>(주)슈가힐</dd>
                            <dt>주소:</dt>
                            <dd>서울특별시 강남구 테헤란로7길 12 허바허바빌딩 4층</dd>
                            <dt>전화번호:</dt>
                            <dd>1599-4385</dd>
                            <dt>이메일:</dt>
                            <dd>help@sugarhill.co.kr</dd>
                        </dl>
                    </span>
                </li>
                <li>
