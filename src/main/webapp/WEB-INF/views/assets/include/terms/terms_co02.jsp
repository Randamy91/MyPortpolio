	...
	<div style="overflow-x:hidden; overflow-y:auto; width:100%; height:150px;" class="sg-main">
        <section class="sg-main__title">
            ...
            <div class="select_box">
                ...
                <select id="color" name="select" class="colors" onchange="if(this.value) location.href=(this.value);">
                    ...
                    <option value="/policy/181213/servicePolicy.html?v=637020366704469484">2018년 12월 13일 시행안</option>
                    <option value="/policy/190318/servicePolicy.html?v=637020366704469484">2019년 3월 18일 시행안</option>
                    <option value="/policy/190612/servicePolicy.html?v=637020366704469484">2019년 6월 12일 시행안</option>
                    <option value="/policy/servicePolicy.html?v=637020366704469484" selected="selected">[현행] 2019년 9월 1일 시행안</option>
                </select>
                <span class="select_box__bg"></span>
                <span class="tri"></span>
            </div>
        </section>
        <section class="sg-agent" id="begin">
            ...
            <h2>제 1조 목적</h2>
            <p>
                이 약관은 (주)슈가힐(이하 "회사"라 한다)이 운영하는 인터넷 사이트 및 모바일 어플리케이션(이하 "세모"라 한다)
        ...
        <section class="sg-agent">
            ...
            <ol>
                <li>
                    ...
                    <span class="sg-text">
                        세모: "회사"가 컴퓨터 등 정보통신설비를 이용하여 서비스를 제공할 수 있도록 설정한 가상의 영업장을 말하며,
                ...
                <li>
                    ...
                    <span class="sg-text">
                        이용자: "세모"에 접속하여 본 약관에 따라 회사가 제공하는 서비스를 받는 "개인 사용자 회원" 또는 "공인중개사 회원"
                ...
                <li>
                    ...
                    <span class="sg-text">
                        회원: "세모"에 접속하여 본 약관에 따라 회사가 제공하는 서비스를 받는 "개인 사용자 회원" 또는 "공인중개사
                        회원", "비즈니스 회원"을 말합니다.
                    </span>
                </li>
                <li>
                    ...
                    <span class="sg-text">
                        개인 사용자 회원: 회사가 정한 소정의 절차를 거쳐 회사에 개인정보를 제공하여 회원 가입을 한 자로서, "세모"
                        의 정보를 지속적으로 제공 받으며, "회사"가 제공하는 "세모"의 서비스를 계속적으로 이용할 수 있는 자를 말
                ...
                <li>
                    ...
                    <span class="sg-text">
                        공인중개사 회원: "회사"가 정한 소정의 절차를 거쳐 회원 가입을 한 부동산 중개업자로서 "세모"에 매물을 제
                ...
                <li>
                    ...
                    <span class="sg-text">
                        비즈니스 회원: "회사"가 정한 소정의 절차를 거쳐 회원 가입을 한 공유오피스 담당자와 법인 담당자로서 "세모"에
        ...
        <section class="sg-agent">
            ...
            <ol>
                <li>
                    <span class="listNum">1.</span>
                    <span class="sg-text">
                        "회사"는 본 약관의 내용을 이용자가 쉽게 알 수 있도록 "세모"의 인터넷 사이트 및 모바일 애플리케이션에 게
        ...
        <section class="sg-agent">
            ...
            <ol>
                <li>
                    <span class="listNum">1.</span>
                    <span class="sg-text">
                        "회사"는 서비스운영을 위해 별도의 운영정책을 마련하여 운영할 수 있으며, "회사"는 "세모" 인터넷 사이트 및
                ...
                <li>
                    ...
                    <span class="sg-text">
                        ...
                        <ol>
                            ...
                            <li>
                                <span class="listNum">5)</span>
                                <span class="sg-text">기타 "세모"의 이용자를 위하여 제공하는 서비스</span>
                            </li>
                            <li>
                                <span class="listNum">6)</span>
                ...
                <li>
                    ...
                    <span class="sg-text">
                        ...
                        <ol>
                            ...
                            <li>
                                <span class="listNum">4)</span>
                                <span class="sg-text">기타 회원으로 등록하는 것이 "세모"의 기술상 현저히 지장이 있다고 판단되는 경우</span>
                            </li>
                            <li>
                                <span class="listNum">5)</span>
                                <span class="sg-text">
        ...
        <section class="sg-agent">
            ...
            <ol>
                ...
                <li>
                    <span class="listNum">7.</span>
                    <span class="sg-text">
                        "회사" 또는 그로부터 개인정보를 제공받은 제3자는 개인정보의 수집목적 또는 제공받은 목적을 달성한 때에는 당해 개인정보를 지체 없이 파기합니다. 다만, 아래의 경우에는 회원 정보를 보관합니다. 이 경우 회사는 보 관하고 있는 회원 정보를 그 보관의 목적으로만 이용합니다.
                        <ol>
                            <li>
                                <span class="listNum">1)</span>
                                <span class="sg-text">
                                    상법, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계법령의 규정에 의하여 보존할 필요가 있는 경우 "회사"는 관계법령에서 정한 일정한 기간 동안 회원 정보를 보관합니다.
                                </span>
                            </li>
                            <li>
                                <span class="listNum">2)</span>
                                <span class="sg-text">
                                    "회사"가 이용계약을 해지하거나 "회사"로부터 서비스 이용정지조치를 받은 회원에 대해서는 재가입에 대한 승낙거부사유가 존재하는지 여부를 확인하기 위한 목적으로 이용계약종료 후 5년간 성명, 이메일주소, 전화번호를 비롯하여 이용계약 해지와 서비스 이용정지와 관련된 정보 등의 필요정보를 보관합니다.
                                </span>
                            </li>
                        </ol>
                    </span>
                ...
                <li>
                    ...
                    <span class="sg-text">
                        ...
                        통하여 공지합니다. 이 때 회원이 별도의 이의제기를 하지 않을 경우 "세모" 서비스 제공이라는 필수적인 목적
                ...
                <li>
                    <span class="listNum">9.</span>
                    <span class="sg-text">
                        모든 "이용자"는 "세모"로부터 제공받은 정보를 다른 목적으로 이용하거나 타인에게 유출 또는 제공해서는 안
        ...
        <section class="sg-agent">
            ...
            <ol>
                ...
                <li>
                    <span class="listNum">3.</span>
                    <span class="sg-text">
                        "회사"는 "세모" 인터넷 사이트 및 모바일 애플리케이션을 통해 제공되는 정보의 내용을 수정할 의무를 지지
            ...
            <ol>
                <li>
                    ...
                    <span class="sg-text">
                        ...
                        부가정보)와 회원 연락처(회원의 이메일 주소 및 전화번호)를 직접 "세모" 인터넷 사이트 및 모바일 애플리케
                ...
                <li>
                    ...
                    <span class="sg-text">
                        ...
                        매물정보 및 공유사무실 정보 등을 “세모” 인터넷 사이트 및
                ...
                <li>
                    <span class="listNum">6.</span>
                    <span class="sg-text">
                        "회사"는 "세모"에 등록된 매물 및 공유사무실 중 사회통념, 관례 및 회사의 합리적인 판단에 의하여 거래가 부
                        적합하다고 판단되는 경우 이의 삭제를 요청하거나 직권으로 삭제할 수 있으며 해당 회원의 서비스 이용을 정
                        지 혹은 탈퇴시킬 수 있습니다. "세모"에 거래부적합 부동산 매물 및 공유사무실을 등록할 경우, 거래부적합 매
        ...
        <section class="sg-agent">
            ...
            <ol>
                <li>
                    <span class="listNum">1.</span>
                    <span class="sg-text">
                        "회원"이 계약 상품 개시 후 환불 요청시 개시일로부터 경과기간에 해당하는 상품 원가 금액과 총 결제금액의 10% 위약금을 공제 한 후 그 나머지를 환급합니다. "공인중개사 회원"이 중개업을 폐업 신고한 후 환불 요청하는 경우도 같습니다. 단, 상품 계약일로부터 7일 이내 청약철회 요청 시 위약금 없이 상품 개시일로부터 경과기간에 해당하는 상품 원가 금액만 공제하고 그 나머지를 환급합니다.
                    </span>
                </li>
                <li>
                    <span class="listNum">2.</span>
                    <span class="sg-text">
                        신용카드로 결제한 "회원"이 카드 승인일로부터 180일 이내에 환불을 요청할 경우 환불금액이 부분취소처리 됩니다. 단, 그 외의 경우에는 기존에 결제하였던 내역을 전액 취소하며 취소 시점에 따라 1항에 의거한 환불공제 금액을 재승인 합니다. 이 경우 구매 취소 시점과 해당 카드사의 환불 처리기준에 따라 취소금액의 환급 방법과 환급일은 다소 차이가 있을 수 있으며, 사용한 신용카드의 환불 정책은 해당 카드사 정책에 따릅니다.
                    </span>
                </li>
                <li>
                    <span class="listNum">3.</span>
                    <span class="sg-text">
                        "회원"이 타인의 신용카드 또는 휴대전화번호를 도용하여 부당한 이익을 편취하였다고 볼 수 있는 합리적 사유가 있는 경우 "회사"는 "회원"에게 소명 자료를 요청하고 환불을 보류할 수 있습니다.
                    </span>
                </li>
                <li>
                    <span class="listNum">4.</span>
        ...
        <section class="sg-agent">
            <h2>제 19조 저작권의 귀속 및 이용제한</h2>
            <ol>
                <li>
                    <span class="listNum">1.</span>
                    <span class="sg-text">"회원"이 "세모"를 이용하여 작성한 저작물에 대한 저작권 기타 지적 재산권은 "회원"에 귀속합니다.</span>
                </li>
                <li>
                    <span class="listNum">2.</span>
                    <span class="sg-text">
                        "이용자"는 서비스를 이용함으로써 얻은 정보 중 "회사"에게 지적 재산권이 귀속된 정보를 회사의 사전 승낙
                        없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리 목적으로 이용하거나 제3자에게 이용하게 하여서
                        는 안됩니다.
                    </span>
                </li>
            </ol>
        ...
        <section class="sg-agent">
            ...
            <p>본 약관은 2019년 9월 1일부터 적용 합니다.</p>
        </section>
    </div>
</body>
</html>