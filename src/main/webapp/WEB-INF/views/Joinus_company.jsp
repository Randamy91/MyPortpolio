								...
								<tbody>
									<tr>
										...
										<td><input type="text" class="form-control"
											...
											placeholder="중개사무소명을 입력해주세요" style="width: 400px;"></td>
									</tr>
									<tr>
									...
									<tr>
										<th class="active"><span class="left-name">사업자
												등록번호</span></th>
										<td><input type="text" name="coe_number" id="coe_number"
								...
								<tbody>
									<tr>
										...
										<td><input type="text" name="P_name" id="P_name"
											class="form-control" maxlength="20" placeholder="이름을 입력해주세요"></td>
									</tr>
									<tr>
